...
namespace TestRes {
    const char fr0xffe1297f5a13080_bGV2ZWwuZGF0[] = {
    ...
    const std::unordered_map<std::string, std::pair<const char*, size_t>> resourceMap = {
        {"level.dat", {fr0xffe1297f5a13080_bGV2ZWwuZGF0, sizeof(fr0xffe1297f5a13080_bGV2ZWwuZGF0)}},
    };
} // namespace TestRes
